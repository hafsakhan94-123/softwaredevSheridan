...
public class SpellingRobot extends Robot
{
	...
	public void spell(City cty, String message)
	{
		for (int i = 0; i < message.length(); i++)
		{
			...
			switch (c)
			{
				case 'A': this.drawA(cty); break;
				case 'B': this.drawB(cty); break;
				case 'C': this.drawC(cty); break;
				case 'D': this.drawD(cty); break;
				case 'E': this.drawE(cty); break;
				case 'F': this.drawF(cty); break;
				case 'G': this.drawG(cty); break;
				case 'H': this.drawH(cty); break;
				case 'I': this.drawI(cty); break;
				case 'J': this.drawJ(cty); break;
				case 'K': this.drawK(cty); break;
				case 'L': this.drawL(cty); break;
				case 'M': this.drawM(cty); break;
				case 'N': this.drawN(cty); break;
				case 'O': this.drawO(cty); break;
				case 'P': this.drawP(cty); break;
				case 'Q': this.drawQ(cty); break;
				case 'R': this.drawR(cty); break;
				case 'S': this.drawS(cty); break;
				case 'T': this.drawT(cty); break;
				case 'U': this.drawU(cty); break;
				case 'V': this.drawV(cty); break;
				case 'W': this.drawW(cty); break;
				case 'X': this.drawX(cty); break;
				case 'Y': this.drawY(cty); break;
				case 'Z': this.drawZ(cty); break;
